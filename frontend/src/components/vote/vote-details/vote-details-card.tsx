...
export default function VoteDetailsCard({ vote }: any) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'mb-3 rounded-lg bg-white p-2 transition-shadow duration-200 dark:bg-light-dark xs:p-6',
      ...
      >
        <div className="self-start md:col-span-2">
          <h3
            ...
            className="cursor-pointer text-base font-medium leading-normal dark:text-gray-100"
          >
            {vote.title}
          </h3>
          <AnimatePresence>
